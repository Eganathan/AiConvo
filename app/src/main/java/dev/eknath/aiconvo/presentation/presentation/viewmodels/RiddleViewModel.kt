...
class RiddleViewModel(private val koogHelper: KoogHelper) : ViewModel() {
    ...
    fun fetchARiddle() {
        viewModelScope.launch {
            ...
            val riddleResponse = koogHelper.generate(PROMPT_ACTIVITY.RIDDLE.prompt)
...
class RiddleViewModelFactory(private val koogHelper: KoogHelper) :
    ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(RiddleViewModel::class.java)) {
            return RiddleViewModel(koogHelper) as T
        }
